...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'django_stocks_company', 'min_date')

        # Deleting field 'Company.max_date'
        db.delete_column(u'django_stocks_company', 'max_date')


    models = {
        'django_stocks.attribute': {
            ...
            'namespace': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['django_stocks.Namespace']"}),
        ...
        'django_stocks.attributevalue': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'values'", 'to': "orm['django_stocks.Attribute']"}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attributes'", 'to': "orm['django_stocks.Company']"}),
            'end_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'filing_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['django_stocks.Unit']"}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '40', 'decimal_places': '6'})
        },
        'django_stocks.company': {
        ...
        'django_stocks.index': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filings'", 'to': "orm['django_stocks.Company']"}),
        ...
        'django_stocks.unit': {
            ...
            'true_unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['django_stocks.Unit']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        }
    }
