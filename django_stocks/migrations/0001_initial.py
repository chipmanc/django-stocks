# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-21 06:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='values', to='django_stocks.Attribute')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticker', models.CharField(blank=True, db_column=b'ticker', db_index=True, help_text='Caches the trading symbol if one is detected in the\n            filing during attribute load.', max_length=50, null=True, verbose_name='ticker')),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='filings', to='django_stocks.Company')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attributes', to='django_stocks.Company'),
        ),
        migrations.AddField(
            model_name='attributevalue',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_stocks.Unit'),
        ),
        migrations.AddField(
            model_name='attribute',
            name='namespace',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_stocks.Namespace'),
        ),
        migrations.AlterUniqueTogether(
            name='index',
