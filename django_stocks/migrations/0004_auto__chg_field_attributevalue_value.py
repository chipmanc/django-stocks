...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttributeValue.value'
        db.alter_column(u'django_stocks_attributevalue', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=40, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'AttributeValue.value'
        db.alter_column(u'django_stocks_attributevalue', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=6))
