...
from .utils import prep_fs_download
...
class Index(models.Model):
    ...
    class Meta:
        ...
        # form type.
        unique_together = (('company', 'form', 'date',
    ...
    def xbrl(self):
        with prep_fs_download(self.xbrl_link) as filename:
            urllib.urlretrieve(self.xbrl_link, filename)
